<template>
    <div class="card-container">
        ...
        <common-table :data="tableData" :isShow="false">
            ...
            <el-table-column prop="feeAmt" label="计费标准"width="160">
                <template slot-scope="scope">
        ...
        <form-dialog ref="formDialog" :formDialogTitle="formDialogTitle" :model="dialogModel"
            ...
            <el-form-item label="计费方式" prop="feeType" v-if="authId">
...
<script>
    ...
    import OrganAuthService from 'service/OrganAuthService'
    ...
    export default {
        ...
        data(){
            return{
                ...
                tableData:[],
                formDialogTitle:'',
                submitService:OrganAuthService.list,
                params:{},
                authId:'',
                dialogRules: {
                    tatSimpleId: [{
        ...
        computed:{
            ...
            dialogService() {
                if (this.authId) {
                    return OrganAuthService.update;
                } else {
                    return OrganAuthService.add;
                }
            },
            dialogData() {
                const params = {
        ...
        methods:{
            ...
            getList() {
                this.doLoad(OrganAuthService.list, this.submitData, res => {
                    this.doCheck(res, res => {
            ...
            addInfo(){
                this.formDialogTitle = '添加实名认证';
                this.$refs.formDialog.open();
            },
            updateInfo(id){
                this.authId = id;
                this.getDetail();
                this.formDialogTitle = '修改实名认证';
                this.$refs.formDialog.open();
            },
            onSuccess(data){
            ...
            doDisabled(id) {
                ...
                this.doLoad(OrganAuthService.dpstatus, disabledParams, res => {
                    this.doCheck(res, res => {
                        const result = JSON.parse(res.contents);
            ...
            Disabled(id, type) {
                if (type == 0) {
                    this.status = 1;
                    this.showMsg = '确定启用此机构实名？'
                } else if (type == 1) {
                    this.status = 0;
                    this.showMsg = '确定禁用此机构实名？'
                }
            ...
            getDetail() {
                ...
                this.doLoad(OrganAuthService.detail, params, res => {
                    this.doCheck(res, res => {
                        const result = JSON.parse(res.contents);
