    ...
    <div class="card-container">
        <common-el-form :model="model" :rules="rules" :submitData="submitData" @success="onSuccess"
            ...
            <el-form-item label="机构简称" prop="tatSimpleId">
                <el-select v-model="model.tatSimpleId" style="width: 300px">
                    <el-option
            ...
            <p class="commonTitle">还款配置</p>
            <el-form-item label="通道简称" prop="chnId">
                <el-select v-model="model.chnId" style="width: 300px">
                    <el-option
            ...
            <el-form-item label="支付类型" prop="payType">
                <el-select v-model="model.payType" style="width: 300px">
                    <el-option
            ...
            <el-form-item label="结算类型" prop="settleType">
                <el-select v-model="model.settleType" style="width: 300px">
                    <el-option
            ...
            <el-form-item label="手续费类型" prop="feeType">
                <el-select v-model="model.feeType" style="width: 300px">
                    <el-option
            ...
            <el-form-item label="计费标准" prop="feeAmt">
                <div class="flex-row">
                    <el-input-number v-model="model.feeAmt" controls-position="right" :precision="2" :step="0.1"
                                     :min="0" style="width: 300px"></el-input-number>
                    <span class="formSpan">{{model.feeType == 1 ? '%':'元'}}</span>
                </div>
            </el-form-item>
            <el-row>
            ...
            <el-form-item label="备注">
                <el-input v-model="model.remark" type="textarea" resize="none" rows="5"
    ...
    export default {
        ...
        computed: {
            submitData() {
                this.params = {
                    ...
                    tatId: this.tatId,
                    tatSimpleId: this.model.tatSimpleId,
                    chnId: this.model.chnId,
                    payType: this.model.payType,
                    settleType: this.model.settleType,
                    feeType: this.model.feeType,
                    feeAmt: this.model.feeAmt,
                ...
                if (this.model.remark == '' || this.model.remark == undefined) {
                    delete this.model.remark;
                }
                if (this.organId) {
            ...
            submitService() {
                if (this.organId) {
                    return OrganRateService.update;
                } else {
                    return OrganRateService.add;
                }
            },
            commonParams() {
                const params = {
        ...
        methods: {
            getDetail() {
                ...
                this.doLoad(OrganRateService.detail, params, res => {
                    this.doCheck(res, res => {
                        ...
                        this.model.feeAmt = this.model.feeAmt / 100;
