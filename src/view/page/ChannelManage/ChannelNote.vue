<template>
    <div class="card-container">
        <common-top-form :model="formModel" @openAddDialog="addInfo()" :submitService="submitService" :submitData="submitData" @success="onSuccess">
            <el-form-item label="短信简称">
                <el-input v-model="formModel.noteName" placeholder="请输入通道简称"></el-input>
            </el-form-item>
            <el-form-item label="通道名称">
                <el-input v-model="formModel.channelName" placeholder="请输入通道名称"></el-input>
            </el-form-item>
        ...
        <common-table :data="tableData" :isShow="false">
            <el-table-column prop="shortName" label="短信简称" width="160"></el-table-column>
            <el-table-column prop="smsChnName" label="短信通道名称" width="160"></el-table-column>
            ...
            <el-table-column prop="smsDesc" label="备注" width="160"></el-table-column>
    ...
    export default {
        ...
        data() {
            return {
                ...
                tableData: [],
                submitService:ChannelNoteService.list,
            }
        },
        ...
        computed: {
            submitData() {
                this.params = {
                    ...
                    tatId: this.tatId,
                    shortName: this.formModel.noteName,
                    smsChnName: this.formModel.channelName,
                    status: this.formModel.state,
                    userId:this.userId,
        ...
        methods: {
            ...
            getList(){
                this.doLoad(ChannelNoteService.list,this.submitData,res => {
            ...
            doDisabled(id){
                ...
                this.doLoad(ChannelNoteService.dpStatus,disabledParams,res => {
                    this.doCheck(res,res => {
                        const result = JSON.parse(res.contents);
