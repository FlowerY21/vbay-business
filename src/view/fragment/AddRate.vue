        ...
        <common-el-form :model="model" :rules="rules" :submitData="submitData" @success="onSuccess"
            ...
            <div v-if="showType">
                ...
                <el-form-item label="通道简称">
                    <el-select v-model="model.shortName" style="width: 300px">
                        <el-option
            ...
            <el-form-item v-else label="通道简称" prop="shortName">
            ...
            <el-row>
                <el-form-item label="交易时间" prop="transaction">
                    <el-time-picker
                        ...
                        :start-placeholder="model.tranStartTime"
                        :end-placeholder="model.tranEndTime"
                        placeholder="选择时间范围">
                    </el-time-picker>
                </el-form-item>
            </el-row>
                    ...
                    <div class="flex-row vertical-center">
                        ...
                        <div class="flex-row vertical-center">
                            ...
                            <el-date-picker
                                ...
                                range-separator="至"
                                :start-placeholder="model.allowStartDate"
                                :end-placeholder="model.allowEndDate">
                            </el-date-picker>
                        </div>
                    </div>
                </el-form-item>
            ...
            <el-form-item v-if="showType" label="备注">
                <el-input v-model="model.content" type="textarea" resize="none" rows="5"
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            submitService() {
                if (this.id) {
                    return this.serverName.update;
                } else {
                    return this.serverName.add;
                }
            },
            commonParams() {
                const params = {
        ...
        methods: {
            ...
            getDetail() {
                ...
                this.doLoad(this.serverName.detail, params, res => {
                    this.doCheck(res, res => {
                        ...
                        this.transaction[0] = this.model.tranStartTime;
                        this.transaction[1] = this.model.tranEndTime;
                        this.allowTransaction[0] = this.model.allowStartDate;
                        this.allowTransaction[1] = this.model.allowEndDate;
